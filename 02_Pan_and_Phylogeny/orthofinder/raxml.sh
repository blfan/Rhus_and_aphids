...
raxmlHPC-PTHREADS-SSE3 -T 70 -f a -x 123 -p 123 -N 200 -m PROTGAMMABLOSUM62X -k -O -o O.sativa -n all.tre -s ~/project/wubeizi/orthofinder/genome_orthomcl/final16/OrthoFinder/Results_Sep19/Orthogroups/cds/new/all.phy
